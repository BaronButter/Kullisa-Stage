...
replace 's|Microsoft Corporation|KullisaLabs|' package.json
...
replace 's|Microsoft Corporation|KullisaLabs|' build/lib/electron.ts
replace 's|([0-9]) Microsoft|\1 KullisaLabs|' build/lib/electron.ts
